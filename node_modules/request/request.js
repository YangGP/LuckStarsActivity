...
/**
 * 从options中取出，reserved中没有的key-value
 * @param reserved  可以保留的项
 * @param options   需要被过滤的对象
 * @returns {{}}
 */
...
/**
 * 从options中筛选出 reserved没有保留的或者不是函数的key-value
 * @param reserved
 * @param options
 * @returns {{}}
 */
...
Request.prototype.init = function (options) {
  ...
  if (!self._callback && self.callback)
  {
    ...
    self.on('complete', self.callback.bind(self, null));  //触发回调
  }

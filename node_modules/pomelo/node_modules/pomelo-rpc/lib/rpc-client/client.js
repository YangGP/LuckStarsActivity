...
var Client = function(opts) {
  ...
  if(this._context) {
    opts.clientId = this._context.serverId;   //保存当前服务器的id
  }
  this.opts = opts;
  this.proxies = {};
  this._station = createStation(opts);        //通过mailstation创建pomelo-rpc client的核心对象
...
pro.start = function(cb) {
  ...
  var self = this;
  this._station.start(function(err) {  //启动MailStation创建的client
    if(err) {

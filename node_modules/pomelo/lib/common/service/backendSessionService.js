...
BackendSessionService.prototype.create = function(opts) {
  ...
  return new BackendSession(opts, this);   //backendSessionServer的核心对象
};
...
var BackendSession = function(opts, service) {
  ...
  this.__sessionService__ = service;   //核心对象，关联的是/common/service/sessionService.js
};
